...
function LandingPage() {
  ...
  const makeApiRequest = async () => {
    try {
      const response = await axios.post(
        "https://semicolonnetwork.onrender.com/join",
        {}
      );
  ...
  const handleSubmit = (event) => {
    ...
    axios
      .post("https://semicolonnetwork.onrender.com/join", data)
      .then((response) => {
        if (response.status === 201) {
    ...
    <div className="semicolon-network-landing-page">
      <header className="header">
        ...
        <div className="header-right">
          ...
          <button
            className="why-it-matters-button"
            onClick={() => scrollToSection("why-it-matters-section")}
          >
            Why It Matters
          </button>
          <button
            className="your-role-button"
            onClick={() => scrollToSection("your-role-section")}
          >
            Your Role
          </button>
          <button
            className="join-the-team-button"
            onClick={() => scrollToSection("join-the-team-section")}
          >
            Join the team
          </button>
        </div>
      ...
      <div className="semicolon-community">
        <div className="hero-section">
          <h1 className="community-header">
            Building a vibrant <br /> Community Hub
          </h1>
          <h6 className="community-text">
            Join us on this journey to build a platform that empowers our
            community, foster meaningful connections, and redefines how we
            engage and collaborate. Together, we will shape the future of our
            community's digital presence.
          </h6>
          <h6 className="community-text content">
            ...built by ancestors and natives, for ancestors and natives
          </h6>
          <button
            className="join-the-team-community-button"
            onClick={() => scrollToSection("join-the-team-section")}
          >
            Join the team
          </button>
      ...
      <div className="what-we-envision" id="vision-section">
        ...
        <div className="what-we-envision-containers">
          <div className="what-we-envision-container">
            <h3 className="what-we-envision-sub-header">
              <span style={{ color: "#ff2e2e" }}>Seamless</span> <br />{" "}
              Communication
              <img
                className="what-we-envision-image"
            ...
            <p className="what-we-envision-text">
              Imagine a platform that allows you post messages and simplify
              communication. Making it effortless to stay updated on community
              events, academic resources, and news.
            </p>
          </div>
          <div className="what-we-envision-red-container">
            <h3 className="what-we-envision-sub-header">
              ...
              <img
                className="what-we-envision-image"
                src={CollaborationOpportunities}
            ...
            <p className="what-we-envision-text">
              Picture a space where you can easily collaborate with peers on
              projects, share insights, and foster meaningful connections within
              the community.
            </p>
          </div>
          <div className="what-we-envision-container third">
            <h3 className="what-we-envision-sub-header">
              Mentorship & <br />{" "}
              <span style={{ color: "#ff2e2e" }}>Support</span>
              <img
                className="what-we-envision-image"
            ...
            <p className="what-we-envision-text-2">
              Seeking guidance, knowledge, or inspiration? This app will connect
              you with ancestors who can offer valuable insights and support.
              Say goodbye to generic advice and hello to a tailored mentorship
              experience.
            </p>
          </div>
        </div>
      ...
      <div className="why-it-matters" id="why-it-matters-section">
        ...
        <p className="why-it-matters-text">
          Our vision is driven by a passion to strengthen the bonds within our
          school community and enhance the overall experience of being part of
          this vibrant tech community. We believe that by bringing this platform
          to life, we can create a virtual space that mirrors the rich and
          collaborative environment we cherish in our physical community.
        </p>
      </div>
      <div className="your-role" id="your-role-section">
        <div className="your-role-left">
          <h2 className="your-role-header">Your Role</h2>
          <p className="your-role-text">
            We are looking for talented software engineers and product designers
            who share our vision and passion for creating a dynamic and
            inclusive online hub. Wherever your specialization, your skills and
            expertise are vital to making this vision a reality.
          </p>
          <p className="your-role-register-text">
            Are you ready to be part of something special? Register your
            interest today!
          </p>
          <button
            className="your-role-join-the-team-button"
            onClick={() => scrollToSection("join-the-team-section")}
          >
            Join The Team
          </button>
      ...
      <div className="join-the-team" id="join-the-team-section">
        ...
        <form className="registration-form" onSubmit={handleSubmit}>
          ...
          <div>
            ...
            />
            <input
              placeholder="Proficient Language(s)"
              type="text"
              id="proficientLanguages"
              value={proficientLanguages}
              onChange={handleProficientLanguagesChange}
              autoComplete="new-password"
            />
          </div>
          <div>
            {/* <select
              id="ancestorOrNative"
              value={ancestorOrNative}
              onChange={handleAncestorOrNativeChange}
            >
              <option value="" disabled selected hidden>
                Ancestor or Native
              </option>
          ...
          <button
            className="join-the-team-submit-button"
            type="submit"
